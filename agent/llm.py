...
TOOLS: List[Dict[str, Any]] = [
    {
        ...
        "function": {
            "name": "list_files",
            "description": (
                "List files and subdirectories under a path inside the "
                "sandboxed workspace. Use '.' for the workspace root."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "path": {
                        "type": "string",
                        "description": "Path relative to the workspace root. Defaults to '.'.",
                    }
                },
                "required": [],
            },
    ...
    },
    {
        ...
        "function": {
            "name": "run_command",
            "description": (
                "Run a single allowlisted shell-free command inside the workspace "
                "(python, python3, pytest, git, pip only). No shell chaining, "
                "redirection, or piping is permitted."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "command": {
                        "type": "string",
                        "description": "Full command line, e.g. 'pip install requests'.",
                    },
                    "timeout_seconds": {
                        "type": "integer",
    ...
    },
    {
        ...
        "function": {
            "name": "run_tests",
            "description": (
                "Run pytest against a path inside the workspace and report "
                "whether the tests passed, plus full output."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "path": {
                        "type": "string",
                        "description": "Path to test, relative to the workspace root. Defaults to '.'.",
                    },
                    "timeout_seconds": {
                        "type": "integer",
